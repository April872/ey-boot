package org.ant.modules.message.job;

import java.util.List;

import org.ant.common.util.DateUtils;
import org.ant.modules.message.entity.SysMessage;
import org.ant.modules.message.handle.ISendMsgHandle;
import org.ant.modules.message.handle.enums.SendMsgStatusEnum;
import org.ant.modules.message.handle.enums.SendMsgTypeEnum;
...
public class SendMsgJob implements Job {
	...
	public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
		...
		log.info(String.format(" ant-boot 发送消息任务 SendMsgJob !  时间:" + DateUtils.getTimestamp()));
