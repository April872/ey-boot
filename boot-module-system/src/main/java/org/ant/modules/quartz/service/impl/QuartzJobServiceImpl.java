package org.ant.modules.quartz.service.impl;

import java.util.List;

import org.ant.common.constant.CommonConstant;
import org.ant.common.exception.BootException;
import org.ant.modules.quartz.entity.QuartzJob;
import org.ant.modules.quartz.mapper.QuartzJobMapper;
import org.ant.modules.quartz.service.IQuartzJobService;
...
public class QuartzJobServiceImpl extends ServiceImpl<QuartzJobMapper, QuartzJob> implements IQuartzJobService {
	...
	private void schedulerAdd(String jobClassName, String cronExpression, String parameter) {
		try {
			...
			throw new BootException("创建定时任务失败", e);
		} catch (RuntimeException e) {
			throw new BootException(e.getMessage(), e);
		}catch (Exception e) {
			throw new BootException("后台找不到该类名：" + jobClassName, e);
		}
	}
	...
	private void schedulerDelete(String jobClassName) {
		try {
			...
			throw new BootException("删除定时任务失败");
		}
	}
