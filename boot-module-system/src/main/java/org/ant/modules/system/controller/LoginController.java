...
import org.ant.common.constant.CacheConstant;
...
import org.ant.common.util.*;
import org.ant.common.util.encryption.EncryptedString;
import org.ant.modules.shiro.vo.DefContants;
import org.ant.modules.system.entity.SysDepart;
import org.ant.modules.system.entity.SysUser;
import org.ant.modules.system.model.SysLoginModel;
import org.ant.modules.system.service.ISysDepartService;
import org.ant.modules.system.service.ISysLogService;
import org.ant.modules.system.service.ISysUserService;
import org.ant.modules.system.util.RandImageUtil;
...
public class LoginController {
	...
	private Result<JSONObject> userInfo(SysUser sysUser, Result<JSONObject> result) {
		...
		redisUtil.expire(CommonConstant.PREFIX_USER_TOKEN + token, JwtUtil.EXPIRE_TIME*2 / 1000);   //30分钟生存时间
	 ...
	 * @param key
	 */
	@ApiOperation("获取验证码图形")
	@GetMapping(value = "/randomImage/{key}")  //key为前端页面的当前时间currdatetime
