...
import org.ant.common.constant.DataBaseConstant;
import org.ant.common.exception.BootException;
import org.ant.common.system.api.ISysBaseAPI;
import org.ant.common.system.vo.*;
import org.ant.common.util.IPUtils;
import org.ant.common.util.SpringContextUtils;
import org.ant.common.util.SysAnnmentTypeEnum;
import org.ant.common.util.oConvertUtils;
import org.ant.common.util.oss.OssBootUtil;
import org.ant.modules.message.entity.SysMessageTemplate;
import org.ant.modules.message.service.ISysMessageTemplateService;
import org.ant.modules.message.websocket.WebSocket;
import org.ant.modules.system.entity.*;
import org.ant.modules.system.mapper.*;
import org.ant.modules.system.service.ISysDataSourceService;
import org.ant.modules.system.service.ISysDepartService;
import org.ant.modules.system.service.ISysDictService;
...
public class SysBaseApiImpl implements ISysBaseAPI {
    ...
    public String parseTemplateByCode(String templateCode,Map<String, String> map) {
        ...
        if(sysSmsTemplates==null||sysSmsTemplates.size()==0){
            throw new BootException("消息模板不存在，模板编码："+templateCode);
        }
