...
import org.ant.common.util.FillRuleUtil;
import org.ant.common.util.oConvertUtils;
import org.ant.modules.system.entity.SysCategory;
import org.ant.modules.system.mapper.SysCategoryMapper;
import org.ant.modules.system.model.TreeSelectModel;
import org.ant.modules.system.service.ISysCategoryService;
...
public class SysCategoryServiceImpl extends ServiceImpl<SysCategoryMapper, SysCategory> implements ISysCategoryService {
	...
	@Override
	public List<TreeSelectModel> queryListByCode(String pcode) throws BootException {
