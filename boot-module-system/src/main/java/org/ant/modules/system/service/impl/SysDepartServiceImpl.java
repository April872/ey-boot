...
import org.ant.modules.system.mapper.SysDepartMapper;
import org.ant.modules.system.model.DepartIdModel;
import org.ant.modules.system.model.SysDepartTreeModel;
import org.ant.modules.system.rule.OrgCodeRule;
import org.ant.modules.system.service.ISysDepartService;
import org.ant.modules.system.util.FindsDepartsChildrenUtil;
...
//---------- edit begin by gh 20200302
			//不再使用数据库 编码规则表格 sys_fill_rule  的字段rule_code的数据内容
			OrgCodeRule  orgCodeRule = new OrgCodeRule();
			String[] codeArray = (String[])orgCodeRule.execute(null, formData);
...
//-----------edit end by gh
			...
			//String orgType = codeArray[1];    // edited by gh in 202020304
			//sysDepart.setOrgType(String.valueOf(orgType)); // edited by gh in 202020304
