...
import org.ant.modules.demo.mock.MockController;
...
import org.ant.modules.system.service.ISysDataLogService;
...
public class SampleTest {
	...
	public void testSelect() {
		...
		List<BaseDemo> userList = jeecgDemoMapper.selectList(null);
	...
	public void testXmlSql() {
		System.out.println(("----- selectAll method test ------"));
		List<BaseDemo> userList = jeecgDemoMapper.getDemoByName("Sandy12");
		userList.forEach(System.out::println);
	}
